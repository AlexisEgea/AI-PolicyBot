...
class PolicyBot:
    def __init__(self, game):
        ...
        preprocess_data()
        policyFile = open('data/policy.json')
...
# This method has for goal to create the policy
# It loads the player experience,
# Compute average values for tuples
# And select the action with the best score to create the policy.
def preprocess_data():
    data = {}
    # Load data
    ...
    # Save policy
    policy_file = open("data/policy.json", "w")
